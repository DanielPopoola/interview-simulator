...
class FeedbackService:
    ...
    async def generate_feedback(self, session_id: int) -> Feedback:
        ...
        if self.feedback_repo.has_feedback(session_id):
            raise ValidationError("Feedback has already been generated for this session.")
        ...
        return self.feedback_repo.create_feedback(session_id=session_id, **feedback_data)
